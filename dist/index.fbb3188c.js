...
var Snake_1 = require("3830db756bba11b7");
...
var Grid = /** @class */ function() {
    ...
    Grid.prototype.draw = function(ctx) {
        ...
        for(var xPosition = 1; xPosition <= this.divisions; xPosition++)for(var yPosition = 1; yPosition <= this.divisions; yPosition++){
...
function setNewSnakePosition() {
    if (snake.direction === "right" /* Direction.RIGHT */ ) snake.setNewPosition({
        x: snake.positions[0].x + 1,
        y: snake.positions[0].y
    }, grid.divisions);
    if (snake.direction === "left" /* Direction.LEFT */ ) snake.setNewPosition({
        x: snake.positions[0].x - 1,
        y: snake.positions[0].y
    }, grid.divisions);
    if (snake.direction === "up" /* Direction.UP */ ) snake.setNewPosition({
        x: snake.positions[0].x,
        y: snake.positions[0].y - 1
    }, grid.divisions);
    if (snake.direction === "down" /* Direction.DOWN */ ) snake.setNewPosition({
        x: snake.positions[0].x,
        y: snake.positions[0].y + 1
    }, grid.divisions);
}
...
},{"3830db756bba11b7":"6xCUu"}],"6xCUu":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}]},["8F5sj","bDbGG"], "bDbGG", "parcelRequire94c2")
