...
})({"fqzpt":[function(require,module,exports) {
...
function main() {
    ...
    function updateGame() {
        const areOnTheSamePosition = (0, _position.Position).areTheSamePosition(snake.positions[0], foodBlock.position);
        snake.update(areOnTheSamePosition);
        if (areOnTheSamePosition) foodBlock.update();
    }
    function onKeyDown(event) {
        const newDirection = mapKeyToDirection(event.key);
        if (newDirection) snake.direction = newDirection;
    }
    function mapKeyToDirection(key) {
        switch(key){
            case "ArrowLeft":
                return (0, _enums.Direction).LEFT;
            case "ArrowRight":
                return (0, _enums.Direction).RIGHT;
            case "ArrowUp":
                return (0, _enums.Direction).UP;
            case "ArrowDown":
                return (0, _enums.Direction).DOWN;
        }
    }
}
main();

},{"./FoodBlock":"iHaSy","./Grid":"3m6mn","./Position":"ioupC","./Snake":"hIOoe","./enums":"1BBdE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iHaSy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class FoodBlock {
    ...
    draw(ctx, lengthOfBlockEdge) {
        (0, _drawBlockInXYPosition.drawBlockInXYPosition)(ctx, this.position.x, this.position.y, "red", lengthOfBlockEdge);
    }
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fqzpt","WPhGI"], "WPhGI", "parcelRequire94c2")
